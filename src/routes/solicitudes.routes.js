...
router.get("/obtenerSolicitud/:id", verificarTokenMiddleware,checkRoleAuth(['administrador', 'administrador', 'colaborador']),obtenerSolicitudesPorId);

// Ruta para modificar una solicitud por su ID
router.put("/modificarSolicitud/:id", verificarTokenMiddleware, checkRoleAuth(['administrador', 'administrador', 'colaborador']), modificarSolicitudPorId);
