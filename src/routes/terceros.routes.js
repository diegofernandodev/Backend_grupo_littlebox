...
router.put("/modificarTercero/:id", verificarTokenMiddleware,checkRoleAuth(['gerente', 'administrador', 'colaborador']),modificarTerceroPorId);

// Ruta para eliminar un tercero por su ID
router.delete("/eliminarTercero/:id", verificarTokenMiddleware,checkRoleAuth(['gerente', 'administrador']),eliminarTerceroPorId);

// Ruta para guardar un nuevo egreso
router.post("/guardarTercero", verificarTokenMiddleware,checkRoleAuth(['gerente', 'administrador', 'colaborador']),guardarTercero);
